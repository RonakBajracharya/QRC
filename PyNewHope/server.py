...
def main():
    ...
    print('Hospital started. Waiting for a connection...')
    client_socket, client_address = server_socket.accept()
    print('Patient connected:', client_address)

    Patient_message = receive_message(client_socket)

    Hospital_response = "Hospital's NewHope public key"
    send_message(client_socket, Hospital_response)
